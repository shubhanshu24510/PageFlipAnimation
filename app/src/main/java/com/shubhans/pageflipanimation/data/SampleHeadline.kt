...
import com.shubhans.pageflipanimation.R
...
val headlines = listOf(
    Headline(
        ...
        category = "sports",
        imageRes = R.drawable.ic_soccer_stadium
    ),
    Headline(
        ...
        category = "health",
        imageRes = R.drawable.ic_laboratory
    ),
    Headline(
    ...
    Headline(
        ...
        category = "history",
        imageRes = R.drawable.ic_archaeological_site
    ),
    ...
    Headline(
        ...
        category = "local",
        imageRes = R.drawable.ic_city_park
    ),
    Headline(
        ...
        category = "technology",
        imageRes = R.drawable.ic_solar_panels
    ),
    ...
    Headline(
        ...
        category = "local",
        imageRes = R.drawable.public_transport
    )
)